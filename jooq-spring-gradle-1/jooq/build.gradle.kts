...
dependencies {
    ...
    implementation("org.jooq:jooq:$jooqVersion")                // runtime
    jooqGenerator("org.jooq:jooq-codegen:$jooqVersion")         // code generation
...
//                    url = "jdbc:mysql://localhost:3306/jooq_query"
//                    user = "root"
//                    password = "mysql"
//                }
//
